  ...
  <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Running Projects</h1>
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-6 col-xxl-5">
                <div class="title-area text-center"><span class="sub-title sub-title3">Running Projects</span>
                    <h2 class="sec-title">Our Running Projects</h2></div>
            </div>
        </div>
